$(document).ready(function() {
    ...
    $("#alert-thankyou").hide(1000);
    $("#alert-thankyou1").hide(1000);
    $("#alert-thankyou2").hide(1000);
    $("#alert-thankyou3").hide(1000);


    $("#alert-empty").hide(1000);
    $("#alert-valid").hide(1000);

    $("#alert-empty1").hide(1000);
    $("#alert-valid1").hide(1000);

    $("#alert-empty2").hide(1000);
    $("#alert-valid2").hide(1000);

    $("#alert-empty3").hide(1000);
    $("#alert-valid3").hide(1000);

    $("#form").on("submit", function(e){
        e.preventDefault();
        emailinput = document.myform.emailinput.value;
        alertEmpty = $("#alert-empty");
        alertValid = $("#alert-valid");
        thankyou = $("#alert-thankyou");
        document.myform.emailinput.value = "";
        verifyEmail();
    ...
    $("#form1").on("submit", function(e){
        e.preventDefault();
        emailinput = document.myform1.emailinput1.value;
        alertEmpty = $("#alert-empty1");
        alertValid = $("#alert-valid1");
        thankyou = $("#alert-thankyou1");
        document.myform1.emailinput1.value = "";
        verifyEmail();
    });

    $("#form2").on("submit", function(e){
        e.preventDefault();
        emailinput = document.myform2.emailinput2.value;
        alertEmpty = $("#alert-empty2");
        alertValid = $("#alert-valid2");
        thankyou = $("#alert-thankyou2");
        document.myform2.emailinput2.value = "";
        verifyEmail();
    });

    $("#form3").on("submit", function(e){
        e.preventDefault();
        emailinput = document.myform3.emailinput3.value;
        alertEmpty = $("#alert-empty3");
        alertValid = $("#alert-valid3");
        thankyou = $("#alert-thankyou3");
        document.myform3.emailinput3.value ="";
        verifyEmail();
    });
    ...
    function verifyEmail(){
        ...
        if(emailinput == ""){
            alertEmpty.show( "slow", function() {
                alertEmpty.delay(3000).hide(1000);
            });
        }
    ...
    function postToGoogle() {
        $.ajax({
            url: "https://docs.google.com/forms/d/1YNug79G6epsGrQZY7g_a09vBrhPOoSGxx3XbaXfcJp8/formResponse",
            data: {"entry.2111875865": emailinput},
            type: "POST",
            dataType: "xml",
            statusCode: {
                0: function() {
